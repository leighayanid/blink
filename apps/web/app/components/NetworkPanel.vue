<template>
  <div class="flex h-full min-h-0 flex-col bg-swiss-bg/40 dark:bg-swiss-bg-dark/40">
    <div class="flex items-center justify-between gap-4 border-b border-swiss-black dark:border-white bg-swiss-black p-5 dark:bg-white sm:p-6">
    ...
    <div class="flex flex-1 flex-col gap-6 overflow-y-auto p-4 sm:p-6 xl:p-8">
      <div class="border border-swiss-black bg-white p-4 dark:border-white dark:bg-swiss-paper-dark sm:p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <UButton
            variant="ghost"
            size="sm"
            class="self-start rounded-none border border-swiss-black px-4 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-swiss-black hover:bg-swiss-black hover:text-white dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-swiss-black sm:self-auto"
      ...
      <div class="relative flex aspect-[4/3] w-full items-center justify-center overflow-hidden border border-swiss-black bg-white shadow-[6px_6px_0px_0px_#000] dark:border-white dark:bg-swiss-paper-dark dark:shadow-[6px_6px_0px_0px_#fff] sm:aspect-square">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between gap-4 border-b border-swiss-black pb-3 dark:border-white">
